...
export default function FileRow({ file, onDownload, onDelete, isDownloading }) {
  ...
  return (
    <tr className="hover:bg-slate-50/80 transition-colors group">
      ...
      <td className="py-2.5 px-3">
        <div className="flex items-center gap-2.5">
          ...
          <div className="min-w-0">
            <p className="text-xs font-semibold text-slate-800 truncate max-w-[140px] sm:max-w-[200px]" title={file.filename}>
              {file.filename}
            </p>
      ...
      {/* Upload Date */}
      <td className="py-2.5 px-3 text-xs text-slate-500 whitespace-nowrap hidden xl:table-cell">
      ...
      <td className="py-2.5 px-3 hidden 2xl:table-cell">
        <span
          className="text-[11px] text-slate-500 font-mono bg-slate-100 px-2 py-0.5 rounded border border-slate-200 block truncate max-w-[120px] cursor-help"
      ...
      <td className="py-2.5 px-3 text-right whitespace-nowrap">
        <div className="flex items-center justify-end gap-1.5 shrink-0">
          <button
            ...
            className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-blue-600 bg-blue-50 hover:bg-blue-100 border border-blue-200/60 transition-colors cursor-pointer disabled:opacity-50 shrink-0"
            title="Download file"
          >
